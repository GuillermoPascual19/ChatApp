            ...
            <div className="grid grid-cols-1 gap-2">
              {files
                ...
                .map((file, i) => (
                  ...
                  >
                    <span className="text-sm flex-1 dark:text-gray-200">{file.name || `Archivo de ${file.sender}`}</span>
          ...
          <div className="chat-messages">
              ...
              chat.map((msg: string, i: number) => {
                try {
                  ...
                  // Find if this message has an associated file
                    ...
                    <div key={i} className={`flex ${isCurrentUser ? 'justify-end' : 'justify-start'} mb-2`}>
                      ...
                      >
                        ...
                        {associatedFile && (
                          ...
                          >
                            <Paperclip size={12}/>
                            <span className="ml-1">Descargar {associatedFile.name}</span>
                          </button>
                        )}
                      </div>
                    </div>
                  ...
                  // For system messages or other non-JSON messages
                  return (
